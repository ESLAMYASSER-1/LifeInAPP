...
class Edit_Screen_Notes extends StatefulWidget {
  Note _note;
  Edit_Screen_Notes(this._note, {super.key});

  @override
  State<Edit_Screen_Notes> createState() => _Edit_Screen_NotesState();
}

class _Edit_Screen_NotesState extends State<Edit_Screen_Notes> {
